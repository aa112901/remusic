...
public class NetRadioDetailActivity extends BaseActivity {
    ...
    private void loadBaiduAllLists() {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                recyclerView.addItemDecoration(new DividerItemDecoration(NetRadioDetailActivity.this, DividerItemDecoration.VERTICAL_LIST));
            }
        }.execute();
    }
    ...
    private class setBlurredAlbumArt extends AsyncTask<Bitmap, Void, Drawable> {
        ...
        protected Drawable doInBackground(Bitmap... loadedImage) {
            ...
            try {
                drawable = ImageUtils.createBlurredImageFromBitmap(loadedImage[0], NetRadioDetailActivity.this, 20);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return drawable;

...
public class MediaService extends Service {
    ...
    public static final String SERVICECMD = "com.wm.remusic.MediaServicecommand";
    ...
    public static final String NEXT_ACTION = "fcom.wm.remusic.next";
    ...
    private void updateNotification() {
        ...
        if (newNotifyMode == NOTIFY_MODE_FOREGROUND) {
            if (CommonUtils.isMIUI()) {
                startForeground(notificationId, update());
            ...
            if (CommonUtils.isMIUI()) {
                mNotificationManager.notify(notificationId, update());
    ...
    private Notification buildNotification() {
        ...
        int playButtonResId = isPlaying
                ? R.drawable.note_btn_pause_white : R.drawable.note_btn_play_white;

        Intent nowPlayingIntent = new Intent(this, PlayingActivity.class);
        PendingIntent clickIntent = PendingIntent.getActivity(this, 0, nowPlayingIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        //   Bitmap artwork;
//        artwork = ImageLoader.getInstance().loadImageSync(CommonUtils.getAlbumArtUri(getAlbumId()).toString());

//        if (artwork == null) {
//            artwork = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.ic_empty_music2);
//        }
        //Bitmap artwork = BitmapFactory.decodeFile(MusicUtils.getAlbumInfo(this,getAlbumId()).album_art);
        Bitmap artwork = BitmapFactory.decodeResource(getResources(), R.id.play_state);
    ...
    private static final int STOP_FLAG = 0x3;
    ...
    private Notification update() {
        ...
        Bitmap bitmap = BitmapFactory.decodeFile(MusicUtils.getAlbumInfo(this, getAlbumId()).album_art);
        if (bitmap != null) {
            rv.setImageViewBitmap(R.id.image, bitmap);
        } else {
            rv.setImageViewResource(R.id.image, R.drawable.pinpu);
        }
        rv.setTextViewText(R.id.title, getTrackName());
...
//		mNotificationManager.notify(NOTIFICATION_ID, mNotification);
        ...
        rv.setOnClickPendingIntent(R.id.iv_stop, prePIntent);
    ...
    public void open(long id) {
        ...
        mPlaylist.add(new MusicTrack(id, len));
        Insert(new MusicTrack(id, len));
        mPlayer.stop();
        mPlayPos = len;
        openCurrentAndNext();
    }
    ...
    public void Insert(MusicTrack track) {
        mPlaybackStateStore.Insert(track);
    }
    ...
    private static final class ServiceStub extends MediaAidlInterface.Stub {
        ...
        @Override
        public void openId(long id) throws RemoteException {
